...
})(
  {
    ...
    DWVQ: [
      function (require, module, exports) {
        ...
        var e = n(require("/src/data/data"));
        function n(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function t(e, n, t, r, a, s, c) {
          try {
            var i = e[s](c),
              o = i.value;
          } catch (u) {
        ...
        var a = { feedbackArray: null, currentUserL: null };
        exports.initialValues = a;
        var s = function (e) {
          var n = document.querySelector(".feedback-items-wrapper"),
            t = e.map(function (e) {
                  ...
                  switch ((n.prev = n.next)) {
                    case 0:
                      document.querySelector(".feedback-items-wrapper"),
                        (a.feedbackArray = e.default.productRequests),
                        console.log(e.default.productRequests),
                        s(e.default.productRequests);
                    case 4:
                    case "end":
                      return n.stop();
                  }
        ...
        (exports.getSuggestions = s), window.addEventListener("load", c);
      },
      { "/src/data/data": "QUkm" },
    ],
    OfwX: [
      function (require, module, exports) {
        "use strict";
        var e = require("./getSuggestions");
        function t() {
          document.querySelector(".feedback-items-wrapper"),
            document.querySelector(".sidebar__status-display");
          (0, e.getSuggestions)(e.initialValues.feedbackArray);
        }
    ...
    OrYy: [
      function (require, module, exports) {
        ...
        var e = s(require("navigo"));
        function s(e) {
          return e && e.__esModule ? e : { default: e };
        }
        require("/src/assets/styles/styles"), require("babel-polyfill");
        var r = new e.default("/");
        r.on("/new-feedback", function () {});
      },
      {
        "../scripts/modules/buttonToggle": "OGcw",
        "../scripts/modules/getSuggestions": "DWVQ",
        "../scripts/modules/editFeedback": "OfwX",
        navigo: "Jwl3",
...
//# sourceMappingURL=/scripts.c3d026dd.js.map
