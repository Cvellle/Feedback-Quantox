...
var filterBy = function filterBy(toMap, filterProp, filterAvoid) {
  return toMap.filter(function (el) {
    return el[filterProp] == filterAvoid;
  });
};
...
var sortItems = function sortItems(e) {
  ...
  var sorted = (0, _getSuggestions.getLS)("suggestions").sort(function (a, b) {
...
var upvotesAdd = function upvotesAdd(e) {
  ...
  var currentHiddenInput = spanCounter.previousElementSibling; // Values for item object spread
  ...
  feedbackArray[e.currentTarget.parentNode.parentNode.id - 1].likedBy && feedbackArray[e.currentTarget.parentNode.parentNode.id - 1].likedBy.includes(currentUser.name)) {
    ...
    newUpvotesNumber = -1;
    newLikes = newLikes.slice().filter(function (el) {
      el !== currentUser.name;
    });
  } else {
    ...
    newUpvotesNumber = 1;
    newLikes = feedbackArray[e.currentTarget.parentNode.parentNode.id - 1].likedBy ? [].concat(_toConsumableArray(feedbackArray[e.currentTarget.parentNode.parentNode.id - 1].likedBy), [currentUser.name]) : [currentUser.name];
  } // Final spread with calculated values


  feedbackArray = [].concat(_toConsumableArray(feedbackArray.slice(0, e.currentTarget.parentNode.parentNode.id - 1)), [_objectSpread(_objectSpread({}, feedbackArray[e.currentTarget.parentNode.parentNode.id - 1]), {}, {
    upvotes: +feedbackArray[e.currentTarget.parentNode.parentNode.id - 1].upvotes + newUpvotesNumber,
    likedBy: newLikes
...
var getItems = function getItems(toMap, elementKind) {
  var items = toMap && toMap.map(function (el, i) {
    var _el$user, _el$user$image;

    var fileName = el === null || el === void 0 ? void 0 : (_el$user = el.user) === null || _el$user === void 0 ? void 0 : (_el$user$image = _el$user.image) === null || _el$user$image === void 0 ? void 0 : _el$user$image.split("/").pop().split(".jpg")[0];
    var image = _.default[fileName];
    return "\n        <div class=\"item item--".concat(elementKind, "\" data-index=\"").concat(i, "\">\n          <div class=\"info\">\n            <div class=\"profile-image\">\n              <div class=\"").concat(el && el.user && el.user.image && el.user.image.split("/").pop(), "\"\n              style=\"background-image: url(").concat(image, ")\n             \">\n              </div>  \n            </div>\n            <div class=\"name\">\n              <bold>").concat(el === null || el === void 0 ? void 0 : el.user.name, "</bold>\n              <div>@").concat(el === null || el === void 0 ? void 0 : el.user.username, "</div>\n            </div>\n            <span class=\"reply-activate\">reply</span>\n          </div>\n          <div class=\"text\">\n            <span>").concat(!el.replies && el.replyingTo ? "@" + el.replyingTo : "", "</span>\n            ").concat(el === null || el === void 0 ? void 0 : el.content, "\n          </div>\n          <div class=\"reply\">\n            <div class=\"").concat(!el.replies ? "replies-wrapper" : "", "\">\n              ").concat(el !== null && el !== void 0 && el.replies ? getItems(el === null || el === void 0 ? void 0 : el.replies, "reply") : "", "\n            </div>\n            <textarea placeholder=\"Type your reply here\"></textarea>\n            <button class=\"reply-btn\" data-reply-to=\"").concat(el === null || el === void 0 ? void 0 : el.user.username, "\">Post Reply</button>\n          </div>\n        </div>");
  });
...
var editFeedbackModule = function editFeedbackModule(match) {
  ...
  var saveFunction = function saveFunction() {
    ...
    var suggestionsChange = submitBody.status != currentObject.status ? suggestions.filter(function (el) {
      return el.id != currentId;
    }) : [].concat(_toConsumableArray(suggestions.slice(0, currentId - 1)), [submitBody], _toConsumableArray(suggestions.slice(currentId))); // Update storage

    (0, _getSuggestions.updateStorage)("feedbackArray", feedbackArray);
    (0, _getSuggestions.updateStorage)('suggestions', suggestionsChange); // Go back to speciffic route
  ...
  var validateFunction = function validateFunction() {
    var btnBoolean = [nameInput, details].every(function (el) {
...
var newFeedbackModule = function newFeedbackModule(match) {
  ...
  var validateFunction = function validateFunction() {
    ...
    !btnBoolean ? addBtn.disabled = true : addBtn.disabled = false;
  };
...
function roadmapLists() {
  ...
  var shown = [];
  var all = (0, _getSuggestions.getLS)("feedbackArray");
  ...
  roadmapColumnsWrapper.innerHTML = columnsLists();
  (0, _sharedFunctions.addItemDetailsListener)(); // Mobile switch columns
...
//# sourceMappingURL=/scripts.accea846.js.map